define([], function() {
  return {
   ...
   //Custom List labels
    ...
    "CustomListTrue": "Sandt",
    "CustomListFalse": "Fake",
    "CustomListOK": "Ok",
    "CustomListCancel": "Annuller",
    "CustomListEdit": "Rediger",
    "CustomListDel": "Slet",
    "CustomListYes": "Ja",
    "CustomListNo": "Nej",
    "CustomListConfirmDel": "Bekræftelse",
    "CustomListConformDelMssg": "Er du sikker på du vil slette dette element?",
    "CustomListFieldMissing": "Fejl '{0}' felt er obligatorisk",

    //SPListQuery labels
    //Copy the following labels in your project if you want to use the SPListQuery
    "SPListQueryList": "Liste",
    "SPListQueryOrderBy": "Sorter efter",
    "SPListQueryArranged": "Rækkefølge",
    "SPListQueryMax": "Maksimalt",
    "SPListQueryAdd": "Tilføje et filter",
    "SPListQueryRemove": "Slet",
    "SPListQueryOperatorEq": "Lige",
    ...
    "PicturePickerTitle": "Vælg et billede",
    "PicturePickerRecent": "De seneste",
    "PicturePickerSite": "Site",
    "PicturePickerButtonSelect": "Vælg et billede",
    ...
    "DocumentPickerTitle": "Vælg et dokument",
    "DocumentPickerRecent": "De seneste",
    "DocumentPickerSite": "Site",
    "DocumentPickerButtonSelect": "Vælg et dokument",
    "DocumentPickerButtonReset": "Slette",

    //PeoplePicker labels
    //Copy the following labels in your project if you want to use the PeoplePicker
    "PeoplePickerSuggestedContacts": "Foreslåede kontaktpersoner",
    ...
    "SPFolderPickerDialogTitle": "Vælg en mappe",
    "SPFolderPickerSelectButton": "Vælg",
    "SPFolderPickerCancelButton": "Annuller",
